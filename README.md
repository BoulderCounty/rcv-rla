...
* You will need access to the following files:
  * Dominion Files (these are generated by the Dominion Voting System):
    ...
    * CvrExport.json
  * Non-Dominion Files
    * A ballot manifest associated with the contest. This file should be in Excel (xlsx) format, and contain only the following columns (with case and spellings exactly as indicated):
      ...
      * **VBMCart.Cart number**: Storage location (single integer value)
...
### Activating the RLA Environment
